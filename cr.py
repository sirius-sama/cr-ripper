...
# Checking crunchyroll version
if 'beta' in meta['URL']:
    download_cmd = f"yt-dlp --external-downloader aria2c {meta['URL']} --cookies '{cookies}' -f 'best[height={meta['episode_info']['height']}]' --write-subs -o '{current_directory}/[RAW]{properTitle}.%(ext)s'"
else:
